...
def formateaSFT(logger, nombre_archivo, nombre_archivo_nuevo):
    try:
        ...
        # Eliminar todas las columnas excepto "input" y "output"
        columnas_a_mantener = ['Nombre', 'Valor nutricional']
        columnas_a_mantener = ['Nombre', 'URL']
...
def execute(name):
    ...
    dir = 'E:/dt/Anaconda3/pycharm/TestTogetherIA/'
    filename = dir + name + '.log'
    #nombre_archivo = dir + 'RecetasGratis.csv'
    #nombre_archivo_nuevo = dir + 'RecetasGratisSFTTodo.csv'
    nombre_archivo = dir + 'recetasabuela.csv'
    nombre_archivo_nuevo = dir + 'recetasabuela_URL10_gemma.csv'
